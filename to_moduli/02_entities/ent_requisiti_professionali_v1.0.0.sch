...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:pattern id="requisiti_professionali_ab" abstract="true">
        ...
        <sch:rule id="rule_requisiti_professionali_ab_requisiti_professionali" context="$requisiti_professionali">
            <sch:extends rule="rule_requisiti_professionali_ab"/>
        </sch:rule>
        
        <sch:include href="../02_entities/ent_persona_v1.0.0.sch#rule_persona_ab"/>
        
        <sch:rule id="rule_requisiti_professionali_ab_requisiti_professionali_preposto_ab" abstract="true">
        ...
        <sch:rule id="rule_requisiti_professionali_ab_requisiti_professionali_preposto" context="ereqpro:requisiti_professionali_preposto">
            <sch:extends rule="rule_requisiti_professionali_ab_requisiti_professionali_preposto_ab"/>
        </sch:rule>
        
        <sch:include href="../02_entities/ent_indirizzo_italiano_v1.0.0.sch#rule_indirizzo_italiano_ab"/>
        
        <sch:rule id="rule_requisiti_professionali_ab_luogo_corso_ab" abstract="true">
        ...
        <sch:rule id="rule_requisiti_professionali_ab_luogo_corso" context="ereqpro:luogo_corso">
            <sch:extends rule="rule_requisiti_professionali_ab_luogo_corso_ab"/>
        </sch:rule>
        ...
        <sch:rule id="rule_requisiti_professionali_ab_iscrizione_registro_ab" abstract="true">
        ...
        <sch:rule id="rule_requisiti_professionali_ab_iscrizione_registro" context="ereqpro:iscrizione_registro">
            <sch:extends rule="rule_requisiti_professionali_ab_iscrizione_registro_ab"/>
        </sch:rule>
        
        <sch:include href="../02_entities/ent_iscrizione_REC_v1.0.0.sch#rule_iscrizione_rec_ab"/>
        
        <sch:rule id="rule_requisiti_professionali_ab_iscirizione_rec_ab" abstract="true">
        ...
        <sch:rule id="rule_requisiti_professionali_ab_iscirizione_rec" context="ereqpro:iscrizione_REC">
            <sch:extends rule="rule_requisiti_professionali_ab_iscirizione_rec_ab"/>
        </sch:rule>
