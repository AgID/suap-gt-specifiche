...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:pattern id="indirizzo_italiano_ab" abstract="true">
        ...
        <sch:rule context="$indirizzo_italiano">
            ...
            <sch:let name="ilcomune" value="normalize-space(eii:comune)"/>
            
            <sch:assert test="$ilcomune">
                Il comune deve essere valorizzato..
            </sch:assert>
            ...
            <sch:assert id="ass_comune_cl_check" test="count($keysComuni[
                ...
                Comune non esiste [[ <sch:value-of select="$ilcomune"/> ]]  Elemento completo: [[<sch:value-of select="$indirizzo_italiano"/>]]
            </sch:assert>
