...
<xsl:stylesheet xmlns:eii="http://entita/indirizzo_italiano"
                ...
                version="2.0"
                xml:base="file:/D:/Insiel/git%20repos/suap-gt-specifiche/to_moduli/moduli_fvg/02_entita/test_cases/ent_indirizzo_italiano_v1.0.0.tc.sch_xslt_cascade"><!--Implementers: please note that overriding process-prolog or process-root is 
