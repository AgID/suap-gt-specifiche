...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:include href="../03_sections/sez_mod_esercizio_media_grande_apertura_v1.0.0.sch#segnalazione_avvio_ab"/>    
    <sch:include href="../02_entities/ent_modalita_vendita_v1.0.0.sch#modalita_vendita_ab"/>
    <sch:include href="../03_sections/sez_mod_esercizio_media_grande_apertura_v1.0.0.sch#carattere_esercizio_ab"/>
    ...
    <sch:pattern id="carattere_esercizio" abstract="false" is-a="carattere_esercizio_ab">
        <sch:param name="carattere_esercizio" value="sapesmegr:carattere_esercizio"/>        
    </sch:pattern>
