...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:pattern id="att_dichiarante_ab" abstract="true">
        ...
        <sch:rule id="rule_att_dichiarante_ab_persona" context="$nsdichia:persona">
            <sch:extends rule="rule_persona_ab"/>
        </sch:rule>
        
        <sch:include href="../02_entities/ent_indirizzo_estero_v1.0.0.sch#rule_indirizzo_estero_ab"/>
        
        <sch:rule id="rule_att_dichiarante_ab_indirizzo_estero" context="$nsdichia:indirizzo_estero">
        ...
        <sch:rule id="rule_att_dichiarante_ab_indirizzo_italiano" context="$nsdichia:indirizzo_italiano">
            <sch:extends rule="rule_indirizzo_italiano_ab"/>
        </sch:rule>
    </sch:pattern>
    
    <sch:pattern id="rule_att_dichiarante" abstract="false" is-a="att_dichiarante_ab">
        <sch:param name="nsdichia" value="sdichia"/>        
    </sch:pattern>
