...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:ns uri="http://agid.it/suap/sections/apertura_esercizio_medio_grande" prefix="sapesmegr"/>
    ...
    <sch:pattern id="carattere_esercizio_ab" abstract="true">
        ...
        <sch:rule context="$carattere_esercizio">
            <sch:assert id="carattere_esercizio_ab-carattere_esercizio" test="normalize-space(permanente)!='' or normalize-space(stagionale)!=''"> 
                Almeno uno tra "Permanente" o "Stagionale"
            </sch:assert>
            
            <sch:assert id="carattere_esercizio_ab-no_stagionale" test="normalize-space(temporaneo)=''"> 
