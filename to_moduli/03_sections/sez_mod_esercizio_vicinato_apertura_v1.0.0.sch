...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:pattern id="segnalazione_avvio_ab" abstract="true">
        ...
        <sch:rule context="$segnalazione_avvio">
            <sch:assert id="segnalazione_avvio_ab-segnalazione_avvio" test="normalize-space(sapesvi:esercizio_vicinato)!='' 
                    or normalize-space(sapesvi:esclusiva_apparecchi_automatici)!=''"> 
