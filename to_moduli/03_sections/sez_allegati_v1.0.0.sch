...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"> 
    ...
    <sch:pattern id="allegati_ab" abstract="true">        
        ...
        <sch:rule id="allegati_ab_procura_delega" context="$nsallegati:procura_delega">
        ...
        <sch:rule id="allegati_ab_dichiarazione_requisiti_soci" context="$nsallegati:dichiarazione_requisiti_soci">
            <sch:extends rule="rule_files_ab"/>
        </sch:rule>
        
        <sch:rule id="allegati_ab_planimetria_locali" context="$nsallegati:planimetria_locali">
            <sch:extends rule="rule_files_ab"/>
        </sch:rule>
        
        <sch:rule id="allegati_ab_assolvimento_imposta_bollo" context="$nsallegati:assolvimento_imposta_bollo">
            <sch:extends rule="rule_files_ab"/>
        </sch:rule>
        
        <sch:rule id="allegati_ab_attestamento_versamenti" context="$nsallegati:attestamento_versamenti">
            <sch:extends rule="rule_files_ab"/>
        </sch:rule>
